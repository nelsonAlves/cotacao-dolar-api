...
public class CotacaoDTO implements Serializable {
	...
	private static final long serialVersionUID = 5827727512537804790L;
	  ...
	  public CotacaoDTO(BigDecimal cotacaoCompra, BigDecimal cotacaoVenda,
	  ...
	  public boolean equals(Object obj) {
	    ...
	    if (getClass() != obj.getClass())
	      return false;
	    CotacaoDTO other = (CotacaoDTO) obj;
	  ...
	  public String toString() {
	    return "CotacaoDTO [cotacaoCompra=" + cotacaoCompra + ", cotacaoVenda=" + cotacaoVenda
